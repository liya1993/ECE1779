...
def courses_view(id):
    ...
    return render_template("courses/view.html",title="Course Details",id=id,code=code, ctitle=title, description=description)
...
def courses_create_save():
    ...
    if error:
        return render_template("courses/new.html",title="New Course",error_msg=error_msg, code=code, ctitle=title, description=description)
